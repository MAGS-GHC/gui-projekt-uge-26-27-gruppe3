  ...
  return (
    <main>
      <div id="order-summary" className="flex flex-col m-5 gap-5 justify-center items-center">
        ...
        <div className="bg-grey border-solid border-2 border-black rounded-md p-2">
          <ul>
            <li> <b>x2</b> Billet (Viborg mod Herning)
      ...
      <div className="flex justify-center items-center h-screen sm:h-auto">
        <div className="flex flex-col sm:flex-row basis-1/3 sm:basis-2/3 justify-evenly text-4xl mt-0 sm:m-10">
          <button className="bg-blue-500 hover:bg-blue-700 hover:text-white font-bold py-2 px-10 border border-blue-700 rounded bg-grey hover:bg-black" onClick={() => setSektion(1)}>
            MobilePay
          </button>
          ...
          <button className="bg-blue-500 hover:bg-blue-700 hover:text-white font-bold py-2 px-10 border border-blue-700 rounded bg-grey hover:bg-black" onClick={() => setSektion(3)}>
            Card
          </button>
        </div>
      </div>
      <section>
        ...
        {sektion == 1 ? (
          <div className="flex flex-col justify-center items-center gap-3">
            ...
            <button className="bg-grey border-solid  border-2 rounded-md p-1"> Sende anmodning</button>
          </div>
          ...
          <div className="flex flex-col justify-center items-center gap-3 w-full">
            <div className="flex flex-col justify-center items-center gap-3"> 
              ...
              <div className="flex justify-center align-center">
                ...
                <input className="peer h-1/2 w-2/12 rounded-[7px] border border-blue-gray-200 border-t-transparent bg-transparent px-3 py-2.5 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-t-transparent focus:outline-0" 
            ...
            <button className="bg-grey border-solid border-2 rounded-md p-1" onClick={() => setIsModalOpen(true)}>Pay</button>
